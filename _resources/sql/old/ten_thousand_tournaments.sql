...
-- -----------------------------------------------------
-- Table `ten_thousand_tournaments`.`reps`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ten_thousand_tournaments`.`reps` ;

CREATE TABLE IF NOT EXISTS `ten_thousand_tournaments`.`reps` (
  `id` INT NOT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_reps_players`
    FOREIGN KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `ten_thousand_tournaments`.`teams` (
  ...
  `rep_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_teams_reps1_idx` (`rep_id` ASC),
  CONSTRAINT `fk_teams_reps1`
    FOREIGN KEY (`rep_id`)
    REFERENCES `ten_thousand_tournaments`.`reps` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ten_thousand_tournaments`.`divisions_players_seasons_teams` (
  ...
  PRIMARY KEY (`division_id`, `player_id`, `season_id`, `team_id`),
...
CREATE TABLE IF NOT EXISTS `ten_thousand_tournaments`.`admins_leagues_roles` (
  ...
  PRIMARY KEY (`league_id`, `admin_id`, `role_id`),
